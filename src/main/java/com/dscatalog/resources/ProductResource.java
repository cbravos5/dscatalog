...
public class ProductResource { 
    ...
    @PostMapping
    public ResponseEntity<ProductDTO> insert(@RequestBody NewProductDTO request) {
        ProductDTO category = service.insert(request);
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<ProductDTO> update(@PathVariable Long id, @RequestBody NewProductDTO request) {
        ProductDTO category = service.update(id, request);
